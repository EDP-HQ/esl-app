    ...
    const model: AppMenuItem[] = [
        ...
        },
        {
            ...
            items: [
                ...
                { label: 'TWBN-WRCP Tool', icon: 'pi pi-fw pi-check-square', to: '/kcvl/twbnwrcp' },
                { label: 'FD Tool', icon: 'pi pi-fw pi-check-square', to: '/kcvl/fdtool' },
                { label: 'LLE', icon: 'pi pi-fw pi-check-square', to: '/kcvl/lle'}
                // ,
                // { label: 'Table', icon: 'pi pi-fw pi-table', to: '/uikit/table' ,, class: 'rotated-icon' },
