...
import { pdfUpload, qcfiles_search, qcfiles_insert, qcfiles_cancelYN, qcfiles_delete,withAuth} from '../../../api/kcvl'
...
const CordTypePage = () => {
    ...
    const [fGroup, setFGroup] = useState('CT'); // CT - Cord Type , TWBN, FD, LLE
    ...
    return (
        <div className="grid">
            <div className="col-12">
                <Toast ref={toast} />
                <div className="card">
                    <h5>TW Cord Type Check Result</h5>
...
export default withAuth(CordTypePage);
